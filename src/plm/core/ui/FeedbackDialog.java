...
public class FeedbackDialog extends JDialog {
    ...
    public void initComponent() {
        ...
        sendBtn.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                client.setOAuth2Token("5b01a853a446d7c243bf2d825ea8ea7dbee8f929");
                ...
                try {
                    issueService.createIssue("Cedric-Huguenin", "PLM", issue);
                    JOptionPane.showMessageDialog(null, "Message reporté", "Succès", JOptionPane.INFORMATION_MESSAGE);
                    dispose();
